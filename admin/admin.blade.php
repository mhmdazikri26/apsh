            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-light btn-primary mt-auto" href="{{ route('security.add_to_cart',$products->id) }}"><i class="fa fa-shopping-cart"> Add to cart</i></a></div>
                    </div>
                </div>
            </div>
            @endforeach
